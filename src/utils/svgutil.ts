...
export default class SvgUtil {
    ...
    static createChevronLeftIcon(): SVGSVGElement {
        return this.createSVG([
            { tagName: "path", attributes: { d: "M15 18l-6-6 6-6" } },
        ]);
    }

    static createChevronRightIcon(): SVGSVGElement {
        return this.createSVG([
            { tagName: "path", attributes: { d: "M9 18l6-6-6-6" } },
        ]);
    }

	static createCloseIcon(): SVGSVGElement {
        return this.createSVG([
            { tagName: "path", attributes: { d: "M18 6L6 18M6 6l12 12" } },
        ]);
    }

    static createSettingsIcon(): SVGSVGElement {
        return this.createSVG([
            { tagName: "path", attributes: { d: "M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z" } },
            { tagName: "circle", attributes: { cx: "12", cy: "12", r: "3", fill: "none" } },
        ]);
    }
